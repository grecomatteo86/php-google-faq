<?php
    ...
    foreach($faq as $valQuestion){
        $cicledQuestion = "{$valQuestion["question"]}";
        var_dump($cicledQuestion);
    }

   foreach($faq as $valAnswer){
       $cicledAnswer = "{$valAnswer["answer"]}";
       var_dump($cicledAnswer);
   }
...
<body>
    <h2><?php echo $cicledQuestion ?></h2>
    <p><?php echo $cicledAnswer ?></p>
</body>
</html>